...
def game_intro():
    ...
    while intro:
        ...
        surf,rect=text_objects("Gump Run",text_size)
...
def message_display(text):
    text_size=pygame.font.Font('freesansbold.ttf',50) ##to display msg we are loading a font and its size
...
def crash(timet):
    ...
    if(timet>12.00):
        message_display2('Slower Than BOLT!!')
